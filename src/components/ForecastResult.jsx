...
function ForecastResult({ forecast, interpretation }) {
  ...
  // Couleurs personnalisées pour chaque région (max 10)
  const regionColors = [
    "#2563eb",
    "#16a34a",
    "#f59e42",
  ...
  return (
    <div className=" flex flex-col  gap-8">
      <div className="flex justify-center  item-center gap-2 ">
        ...
        <div className="w-4/6 bg-white rounded-2xl shadow-xl p-6 transition hover:shadow-2xl">
          <h2 className="font-bold text-xl text-blue-700 mb-4 tracking-tight flex items-center gap-2">
        ...
        {/* Prévision nationale */}
        <div className="w-3/6 bg-white rounded-2xl shadow-xl p-6 transition hover:shadow-2xl">
          <h2 className="font-bold text-xl text-blue-700 mb-4 tracking-tight flex items-center gap-2">
            <span className="inline-block w-2 h-6 bg-blue-600 rounded-full mr-2" />
            Prévision nationale{" "}
            <span className="font-normal text-gray-500 text-base">
          ...
          <Chart
            ...
            options={{
              ...
              yaxis: {
                title: {
                  text: "Dépenses Prédites nationales (MGA)",
                  style: { fontWeight: 600 },
                },
                labels: { formatter: (val) => val?.toLocaleString() },
              },
            ...
            series={[
              {
                name: "Dépenses nationales",
                data: nationalDepenses,
              },
            ]}
          />
        </div>
      ...
      {/* Interprétation */}
      <div className="relative bg-white rounded-2xl shadow-xl p-6 pl-10 border-l-8 border-blue-600">
